...
write-host 'AIB Customization:  Downloading WinGet Packages'
...
if ([Environment]::Is64BitOperatingSystem) {
	...
	write-host 'AIB Customization:  Installing WinGet pre-requisites (64bit)'
	...
	write-host 'AIB Customization:  Installing WinGet pre-requisites (32bit)'
	Add-AppxPackage -Path $vclibs -ErrorAction Stop
...
write-host 'AIB Customization:  Installing WinGet (user scope)'
Add-AppxPackage -Path $wingetPath -ErrorAction Stop

if (Get-IsAdmin) {
	write-host 'AIB Customization:  Resetting WinGet Sources'
...
write-host 'AIB Customization:  Adding WinGet Source Cache Package'
...
if (Get-IsPacker) {
	...
	write-host 'AIB Customization:  Patching WinGet Config'
